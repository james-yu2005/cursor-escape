...
export default function Homepage(){
    ...
    return(
        <div>
            <div>
                <h1 class="text-center mt-20 text-2xl">Welcome to Cursor Escape!</h1>
                <h1 class="mt-4 text-center text-sm mb-20 text-gray-500">Creators: &#40;James, Patrick&#41;</h1>
            </div>
            <h1 class="mt-4 text-center">Welcome <div class="text-blue-400 inline-block">{username}</div> and have fun!</h1>
